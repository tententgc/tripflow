        ...
        {members.length === 0 ? (
          ...
          <div className="divide-y divide-gray-100/60">
            {members.map((m, idx) => {
              ...
              return (
                <div key={m.id} className="flex items-center gap-3.5 px-5 py-3.5 hover:bg-indigo-50/30 transition-colors group">
                  <span className="text-xs text-gray-500 w-4 text-right font-mono flex-shrink-0">{idx + 1}</span>
                  ...
                  <button
                    ...
                    className="p-1.5 text-gray-400 opacity-0 group-hover:opacity-100 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all"
                    title="ลบสมาชิก"
                  >
